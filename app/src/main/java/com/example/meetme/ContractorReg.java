...
public class ContractorReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.contractor_reg);

        back = findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ContractorReg.this, PreRegister.class);
    ...
    private void saveVisitor() {
        ...
        if (visitorName.isEmpty() || visitorPhone.isEmpty() || visitDate.isEmpty() || visitTime.isEmpty() || visitorVehicle.isEmpty()) {
            Toast.makeText(ContractorReg.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        visitor.put("category", "Contractor");
        ...
        alert.put("message", "New contractor submitted by " + currentUser.getDisplayName());
        alert.put("contractorDetails", visitor);
        ...
        db.collection("visitors").add(visitor).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                db.collection("adminAlerts").add(alert);
                Toast.makeText(ContractorReg.this, "New visitor added successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ContractorReg.this, VisitorDetail.class);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(ContractorReg.this, "Failed to add new visitor", Toast.LENGTH_SHORT).show();
            }
        });

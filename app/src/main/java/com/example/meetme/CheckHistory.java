...
public class CheckHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CheckHistory.this, MainActivity.class);
        ...
        myAdapter = new MyAdapter(CheckHistory.this, visitorArrayList);
    ...
    private void ViewHistory() {
        ...
        db.collection("visitors").whereNotEqualTo("status","Pending").whereEqualTo("userId", currentUserId).addSnapshotListener(new EventListener<QuerySnapshot>() {

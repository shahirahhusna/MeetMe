...
public class OvernightReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.overnight_reg);

        back = findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(OvernightReg.this, PreRegister.class);
    ...
    private void saveVisitor() {
        ...
        if (visitorName.isEmpty() || visitorPhone.isEmpty() || visitDate.isEmpty() || visitTime.isEmpty() || visitorVehicle.isEmpty()) {
            Toast.makeText(OvernightReg.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        visitor.put("category", "Family/Friend");
        ...
        db.collection("visitors").add(visitor).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                Toast.makeText(OvernightReg.this, "New visitor added successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(OvernightReg.this, VisitorDetail.class);
                ...
                intent.putExtra("category", "Family/Friend");
                startActivity(intent);
                finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(OvernightReg.this, "Failed to add new visitor", Toast.LENGTH_SHORT).show();
            }
        });

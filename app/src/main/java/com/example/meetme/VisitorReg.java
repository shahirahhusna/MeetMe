...
public class VisitorReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.visitor_reg);

        back = findViewById(R.id.back);
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(VisitorReg.this, PreRegister.class);
    ...
    private void saveVisitor() {
        ...
        if (visitorName.isEmpty() || visitorPhone.isEmpty() || visitDate.isEmpty() || visitTime.isEmpty() || visitorVehicle.isEmpty()) {
            Toast.makeText(VisitorReg.this, "Please fill in all fields", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        db.collection("visitors").add(visitor).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                Toast.makeText(VisitorReg.this, "New visitor added successfully", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(VisitorReg.this, VisitorDetail.class);
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(VisitorReg.this, "Failed to add new visitor", Toast.LENGTH_SHORT).show();
            }
        });
    }
}